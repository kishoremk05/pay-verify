      ...
      setMessages([
        {
          id: "welcome",
          role: "assistant",
          content: `Hello ${profile?.full_name || "there"}! I am your AI Business Assistant. Ask me anything about payments, invoices, customers, or reports in your organization.`,
  ...
  const handleSend = async (textToSend?: string) => {
    ...
    try {
      ...
      if (resData.success && resData.data) {
        ...
        throw new Error(resData.error || "Unknown AI engine failure");
      }
    } catch (err: any) {
      ...
      <html>
        ...
        <body>
          <div class="container">
            ...
            <div class="footer">
              <span>Generated by Todella AI Business Intelligence Assistant</span>
        ...
        <div className="p-4 border-t bg-card">
          ...
          >
            <input
              ...
              disabled={loading}
              placeholder="Ask AI e.g. Show today's payments..."
