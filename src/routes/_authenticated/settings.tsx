  ...
  return (
    <div className="space-y-8 max-w-4xl animate-fade-in">
      <div className="flex flex-col gap-1">
        <h1 className="text-3xl font-extrabold tracking-tight text-foreground sm:text-4xl">Settings</h1>
        <p className="text-sm text-muted-foreground">Manage your personal profile, account preferences, and organization settings.</p>
      </div>
          ...
          <CardHeader className="pb-4 pt-6 border-b border-border/40">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-0.5">Manage your personal identity details</p>
              </div>
            </div>
          </CardHeader>
          <CardContent className="p-6 sm:p-8 space-y-6">
            <div className="space-y-2">
              <Label htmlFor="email" className="text-xs font-bold uppercase tracking-wider text-muted-foreground/80 pl-1 flex items-center gap-1.5">
            ...
            <div className="space-y-2">
              <Label htmlFor="fullName" className="text-xs font-bold uppercase tracking-wider text-muted-foreground/80 pl-1 flex items-center gap-1.5">
            ...
            <div className="space-y-2">
              <Label htmlFor="role" className="text-xs font-bold uppercase tracking-wider text-muted-foreground/80 pl-1 flex items-center gap-1.5">
        ...
        <Card className="border-border/60 bg-card/90 backdrop-blur-xl shadow-[var(--shadow-card)] rounded-[2rem] overflow-hidden transition-all duration-300 hover:shadow-md">
          <CardHeader className="pb-4 pt-6 border-b border-border/40">
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle className="text-lg font-bold tracking-tight">Organization Workspace</CardTitle>
                <p className="text-xs text-muted-foreground mt-0.5">Manage your team workspace properties</p>
              </div>
            </div>
          </CardHeader>
          <CardContent className="p-6 sm:p-8 space-y-6">
            <div className="space-y-2">
              <Label htmlFor="orgName" className="text-xs font-bold uppercase tracking-wider text-muted-foreground/80 pl-1 flex items-center gap-1.5">
              ...
              {role !== "admin" && (
                <div className="mt-3 flex items-start gap-2.5 rounded-2xl bg-amber-500/10 p-4 text-xs text-amber-700 dark:text-amber-400 border border-amber-500/20">
                  ...
                  <div>
                    <span className="font-bold">Admin Privileges Required:</span> You are a member in this workspace. Workspace name settings can only be altered by administrators.
                  </div>
                </div>
              )}
            </div>
